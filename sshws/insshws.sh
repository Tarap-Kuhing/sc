...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Tarap-Kuhing/sc/main/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service
